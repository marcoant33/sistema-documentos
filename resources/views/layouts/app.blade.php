        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar p-0 position-relative">
                ...
                <nav class="nav flex-column">
                    ...
                    <a href="{{ route('documentos.index') }}" class="nav-link text-white">📄 Documentos</a>
                    <a href="{{ route('importaciones.index') }}" class="nav-link text-white">📥 Importar Excel</a>
                    <a href="{{ route('reportes.index') }}" class="nav-link text-white">📊 Reportes</a>
                </nav>
